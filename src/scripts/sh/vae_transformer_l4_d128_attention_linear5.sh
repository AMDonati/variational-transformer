#!/bin/bash
#SBATCH --job-name=linear5-vae-attn-l4-d128-transformer
#SBATCH --qos=qos_gpu-t3
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem-per-cpu=8g
#SBATCH --output=slurm_out/linear5-vae-transformer-attn-l4-d128-%j.out
#SBATCH --error=slurm_out/linear5-vae-transformer-attn-l4-d128-%j.err
